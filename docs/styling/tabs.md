...
A tabbed section may be created by adding a `tabs` class attribute.  When doing this all child sections become individual tabs.  The heading for the child tab is used for the tab label.
